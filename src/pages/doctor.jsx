...
const DoctorDashboard = () => {
  ...
  const samplePatientDetail = {
    ...
    medicalHistory: [
      "Hypertension",
      "Appendectomy (2015)",
      "Family history: Father - CAD, Mother - Type 2 Diabetes",
    ],
  };
  ...
  const handleOpenPatient = (p) => {
    if (p.name === "Ezekiel Okon") {
      setSelectedPatient(structuredClone(samplePatientDetail));
    } else {
      setSelectedPatient({
        id: p.id,
        name: p.name,
    ...
    <div className="dashboard">
      <aside className="sidebar">
        <nav className="sidebar-nav">
          <div className="sidebar-link active"><Grid2x2 width={16} /> Dashboard</div>
          <div className="sidebar-link"><Users width={16} /> Patients</div>
          <div className="sidebar-link"><Pill width={16} /> Prescriptions</div>
          <div className="sidebar-link"><Settings width={16} /> Settings</div>
        </nav>
              ...
              <div className="patient-main">
                <div className="patient-top card">
                  ...
                  <div>
                    ...
                    <p className="patient-meta-row">
                      {selectedPatient.age} • {selectedPatient.gender} • Last seen: {selectedPatient.lastSeen}
                    </p>
                ...
                <div className="notes-card card">
                  ...
                  <div className="add-note">
                    <textarea
                      placeholder="Write a new note about this patient..."
                      value={newNote}
               ...
               <div className="history-card card">
                ...
                <div className="main-card">
                  ...
                  <div className="nested-cards">
                    <div className="nested-card request-records">
                      <h3>Request Records</h3>
                      </div>
                    <div className="nested-card send-message">
                      <h3>Send Message</h3>
                    </div>
                    <div className="nested-card schedule">
                      <h3>Schedule</h3>
                      </div>
                  </div>
                </div>
